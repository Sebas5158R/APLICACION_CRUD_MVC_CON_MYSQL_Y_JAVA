...
<head>
    ...
    <link rel="stylesheet" href="assets/css/retirarNequi.css">
</head>
<body>
    ...
    <form action="bolsillo" method="post" class="form">
        ...
        <div class="form__container">
            <div class="form__group">
                <input type="text" name="cantidad" id="cantidad" class="form__input" placeholder=" " required>
        ...
        <div class="form__container">
            <div class="form__group">
                <input type="text" name="phone" id="phone" class="form__input" placeholder=" ">
        ...
        <div class="form__container">
            ...
            <a href="bolsillo?accion=nequi" class="form__submit">Cancelar</a>
        </div>
    </form>
